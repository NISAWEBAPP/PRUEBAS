...
const geolocation = new ol.Geolocation({
  ...
  projection: view.getProjection(), // 'view' is usually defined by qgis2web
});
...
// 3. Create a feature to show the location dot
const positionFeature = new ol.Feature();
...
// 4. Update position when it changes
geolocation.on('change:position', function () {
...
const overlayLayer = new ol.layer.Vector({
  map: map, // 'map' is the variable qgis2web uses
  source: new ol.source.Vector({
